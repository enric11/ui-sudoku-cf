		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sudoku UI",
									"targetURL": "#ecastellasudokuui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ecastellasudokuui-display": {
								"semanticObject": "ecastellasudokuui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ecastella.sudokuui",
									"url": sap.ui.require.toUrl("ecastella/sudokuui")
								}
							}
						}
					}
